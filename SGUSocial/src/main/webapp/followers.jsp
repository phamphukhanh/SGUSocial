...
<%@ page import="com.sgusocial.User,com.sgusocial.UserDetails,java.io.File,java.util.ArrayList,com.sgusocial.DBUtil,jakarta.annotation.Resource,javax.sql.DataSource"%>
...
<html>
    ...
    <div class="row">
        ...
        if(!user.getEmail().equals(profile.getEmail())){
                ...
                <%
                ArrayList<String> followerEmails=DBUtil.getFollowers(dataSource, profile.getEmail());
                ...
                <div class="scrolling">
                    <div class="card-columns collup">
                        ...
                        for(int i=0;i<followers.size();i++){
                                UserDetails details=DBUtil.getUserDetails2(dataSource, followers.get(i).getEmail());
                                if(details!=null){
                        ...
                        %>
                        <a href=<%="profile.jsp?email="+followers.get(i).getEmail()  %> >
